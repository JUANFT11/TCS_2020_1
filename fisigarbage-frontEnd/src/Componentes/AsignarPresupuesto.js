...
class AsignarPresupuesto extends React.Component{
    ...
    constructor(props){
        ...
        this.state={
            ...
            tipo_programa:[{value:"03",label:"Maestrisa"},{value:"05",label:"Doctorado"},{value:"06",label:"Diplomatura"}],
    ...
    obtenerPresupuesto=()=>{
      fetch(CONFIG+'alumno/alumnoprograma/programa/'+this.state.programa_actual.value) //revisar programa_Actual
        .then((response)=>{
          return response.json();
        })
        .then((programa)=>{

        ...
        <div>
          ...
          <div className="row">
            <div className="  col-md-12">
              ...
              <TableHeader   /> {/*CHECA JUAN: NOMBRE DE LAS TABLAS*/}
...
/************ */
  ...
  document.getElementById("actualizar_header").style.display = statusInfo;
/************ */
  for(var i=1; i<=len; i++){
    ...
    document.getElementById("actualizar"+i).style.display = statusInfo;
    /************ */
  }
}

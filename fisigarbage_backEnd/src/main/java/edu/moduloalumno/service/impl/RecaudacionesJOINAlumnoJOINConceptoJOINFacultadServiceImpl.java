...
public class RecaudacionesJOINAlumnoJOINConceptoJOINFacultadServiceImpl implements IRecaudacionesJOINAlumnoJOINConceptoJOINFacultadService {
	...
	public List<CodigosporNomApe> getCodigoByNombreCodAlumno(String nomApe, String codAlumno) {
		...
		List<CodigosporNomApe> codigosList = recaudacionesJOINAlumnoJOINConceptoJOINFacultadDAO
				.getCodigoByNombreCodAlumno(nomApe, codAlumno);
		return codigosList;
	}    
	@Override
	...
	public int updateAlumnoEstadoCivil(String codigo, String estado_civil) {
		return recaudacionesJOINAlumnoJOINConceptoJOINFacultadDAO.updateAlumnoEstadoCivil(codigo, estado_civil);
	...
	@Override
	public int updateId_Envio(Integer idEnvio,String numero) {
		return recaudacionesJOINAlumnoJOINConceptoJOINFacultadDAO.updateId_Envio(idEnvio,numero);

...
public class RecaudacionesServiceImpl implements IRecaudacionesService {
	...
	@Override
	public int updateRecaudacionesIDEnvio(Recaudaciones recaudaciones) {
		 return recaudacionesDAO.updateRecaudacionesIDEnvio(recaudaciones);
	}

	@Override
	public void updateRecaudacionesIDEnvio(String cod_alumno, String numero, int id_envio) {
		recaudacionesDAO.updateRecaudacionesIDEnvio(cod_alumno, numero, id_envio);
	}
	
	@Override
	public int updateRecaudacionesIDEnvio(List<Recaudaciones> reacaudacionesList) {
		int update = 0;
		for (Recaudaciones recaudaciones : reacaudacionesList) {
			update+=recaudacionesDAO.updateRecaudacionesIDEnvio(recaudaciones);
		}
		return update;
	}

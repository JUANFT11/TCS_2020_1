...
public interface IRecaudacionesService {
	...
	int updateRecaudacionesIDEnvio(Recaudaciones recaudaciones);

	int updateRecaudacionesIDEnvio(List<Recaudaciones> reacaudacionesList);

	void updateRecaudacionesIDEnvio(String cod_alumno, String numero, int id_envio);

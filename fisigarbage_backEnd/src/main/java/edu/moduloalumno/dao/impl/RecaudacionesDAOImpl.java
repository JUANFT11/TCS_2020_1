...
public class RecaudacionesDAOImpl implements IRecaudacionesDAO {
	...
	@Override
	public int updateRecaudacionesIDEnvio(Recaudaciones reacaudaciones) {return 0;}


	public int updateId_Envio(Integer idprograma,String codigo) {
		if(idprograma==0)
			idprograma=null;
	...
	@Override
	public void updateRecaudacionesIDEnvio(String cod_alumno,String numero, Integer id_envio) {
	...
	public List<Recaudaciones> getAllRecaudaciones() {
		...
		String sql = "SELECT id_rec, id_alum, id_concepto, id_registro, id_programa, id_ubicacion, cod_alumno, moneda, numero, importe, fecha, validado, id_tipo, ciclo, repitencia, id_envio  FROM recaudaciones";		
